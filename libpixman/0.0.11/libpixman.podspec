Pod::Spec.new do |spec|
    ...
    spec.source_files           = "libpixman/**/pixman-{access-accessors.c,access.c,arm-asm.c,arm-neon.c,arm-simd.c,arm.c,bits-image.c,combine-float.c,combine32.c,conical-gradient.c,edge-accessors.c,edge.c,fast-path.c,filter.c,general.c,gradient-walker.c,image.c,implementation.c,linear-gradient.c,matrix.c,mips.c,noop.c,ppc.c,radial-gradient.c,region16.c,region32.c,solid-fill.c,timer.c,trap.c,utils.c,x86.c}",
                                  "libpixman/**/pixman.c",
                                  "libpixman/**/pixman-*.h",
                                  "libpixman/**/config.h",
                                  "libpixman/pixman/pixman.h"
